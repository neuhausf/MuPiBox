			...
			<div id="footer">
				...
				<div id="footercenter">
					<ul>
						<li><a href="https://github.com/neuhausf/MuPiBox" target="_blank">Visit MupiBox on Github</a></li>
						<li><a href="https://github.com/neuhausf/MuPiBox/blob/main/LICENSE.md" target="_blank">License / Copyright</a></li>						
					</ul>
				</div>
				<div id="footerright">
